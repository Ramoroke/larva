...
import { vintageCars } from '../data/cars';
...
class Vintage extends Component {
  ...
  preload() {
    // Load the selected vintage car model
    const selectedCar = vintageCars[this.state.selectedCarIndex];
